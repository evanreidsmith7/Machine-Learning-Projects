...
# n_jobs: number of parallel jobs to run for neighbors search(n_nei
'''
# The kNN Model
...
plot_decision_regions(X=X_combined, y=y_combined, classifier=knn, test_idx=range(y_train.size, y_train.size + y_test.size))
