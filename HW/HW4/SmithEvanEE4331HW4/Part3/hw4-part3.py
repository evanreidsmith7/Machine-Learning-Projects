...
##########################################################################################################################
def agglomerative_clustering_dendrogram(X, file_path: str, title: str = 'Dendrogram'):
   # Perform Agglomerative clustering and create linkage matrix
