...
print("\n\n\n\n\nDONE setting up models...\n\n\n\n\n")
print("\n\n\n\n\nfitting for the ensemble grid search...\n\n\n\n\n")
...
print("\n\n\n\n\nfitting grid search done...\n\n\n\n\n\n\n\n")

print("\n\n\n\n\nfitting for the ensemble...\n\n\n\n\n\n\n\n")
...
X_train_plt = pca.fit_transform(X_train_std)
X_test_plt = pca.transform(X_test_std)
