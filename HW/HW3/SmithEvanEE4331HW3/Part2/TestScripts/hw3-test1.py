...
#DEBUG###########################################################################################
pipe_used = "pipe3"
gs = GridSearchCV(estimator=pipe3, param_grid=param_grid, scoring='accuracy', cv=5, n_jobs=-1)###
...
#DEBUG###########################################################################################
print("DEBUG")
print("pipe:", pipe_used)                                                                  ###
print("number of folders traversed: ", num_subdirectories_to_traverse)                        ###
