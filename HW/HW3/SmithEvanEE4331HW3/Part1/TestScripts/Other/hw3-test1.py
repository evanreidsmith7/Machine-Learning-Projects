...
def write_results_to_file(train_accuracy, accuracy, precision, recall, f1, best_model, best_params, g):
    """
    Writes the results to a txt file.

    Parameters:
    train_accuracy (float): The best model train accuracy.
    accuracy (float): The best model test accuracy.
    ...
    g (str): The string to be written at the end of the file.

    Returns:
    None
    """
    with open('Part1/results/tuning/results100f.txt', 'w') as file:
...
best_score3 = 0#gs3.best_score_
best_score4 = gs4.best_score_
best_score5 = gs5.best_score_
best_score6 = 0#gs6.best_score_
...
# txt file
###########################################################################################################################
write_results_to_file(train_accuracy, accuracy, precision, recall, f1, best_model, best_params, g)
